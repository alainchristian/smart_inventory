    ...
    private function loadSummary(): void
    {
        ...
        $sessQ = DB::table('daily_sessions')
            ...
            ->select(
                ...
                DB::raw('SUM(COALESCE(total_expenses_momo, 0))       as total_expenses_momo'),
                ...
                DB::raw('SUM(COALESCE(total_withdrawals_momo, 0))    as total_withdrawals_momo'),
                DB::raw('SUM(COALESCE(total_bank_deposits, 0))       as total_bank_deposits'),
                DB::raw('SUM(COALESCE(cash_deposits, 0))             as cash_deposits'),
                DB::raw('SUM(COALESCE(momo_deposits, 0))             as momo_deposits'),
                DB::raw('SUM(COALESCE(momo_settled, 0))              as momo_settled'),
                DB::raw('SUM(COALESCE(cash_to_owner_momo, 0))        as cash_to_owner_momo'),

...
class DailySession extends Model
{
    ...
    protected $casts = [
        ...
        'momo_deposits'            => 'integer',
        'total_repayments'         => 'integer',
        'total_repayments_cash'    => 'integer',
        'total_repayments_momo'    => 'integer',
        'expected_cash'            => 'integer',
        'actual_cash_counted'      => 'integer',
        'cash_variance'            => 'integer',
        'cash_to_owner_momo'       => 'integer',
        'momo_settled'                  => 'integer',
        'card_settled'                  => 'integer',
        'other_settled'                 => 'integer',
        'bank_transfer_settled'         => 'integer',
        'total_sales_bank_transfer'     => 'integer',
        'total_sales_credit'            => 'integer',

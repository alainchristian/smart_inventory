...
.otl-page-header-left h1 { font-size:29px; font-weight:800; letter-spacing:-.5px; color:var(--text); margin:0; }
...
/* Route */
.otl-route { display:flex; align-items:center; gap:8px; font-size:14px; }
.otl-route-node {
...
.otl-date  { font-size:13px; color:var(--text-sub); }
...
.otl-stat-v { font-size:24px; font-weight:800; color:var(--text); line-height:1; }
.otl-stat-l { font-size:11px; font-weight:700; letter-spacing:.9px; text-transform:uppercase; color:var(--text-sub); }
...
.otl-foot-time { margin-left:auto; font-size:12px; color:var(--text-sub); }
...
.otl-empty h3  { font-size:20px; font-weight:700; color:var(--text); margin:0 0 8px; }
.otl-empty p   { font-size:16px; color:var(--text-sub); margin:0; }
...
@media(max-width:768px) {
    ...
    .otl-page-header h1 { font-size:24px; }
    ...
    .otl-action { flex:1; justify-content:center; font-size:12px; }
}

@media(max-width:640px) {
    .otl-page-header h1 { font-size:22px; }
    .otl-dropdown-btn { font-size:13px; padding:9px 14px; }
    .otl-card { border-radius:8px; }
    .otl-card-top { padding:0 14px; }
    .otl-card-info { padding:12px 0; }
    .otl-num { font-size:15px; }
    .otl-badge { font-size:10px; padding:2px 8px; }
    .otl-route { font-size:13px; gap:6px; }
    ...
    .otl-stat-v { font-size:20px; }
    .otl-stat-l { font-size:10px; }
    ...
    .otl-empty h3 { font-size:18px; }
    .otl-empty p { font-size:14px; }
    .otl-wrap { gap:16px; }
}

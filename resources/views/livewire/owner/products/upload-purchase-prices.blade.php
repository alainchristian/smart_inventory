  ...
  <div>
    ...
    <div class="flex items-center justify-end gap-3 border-t border-[var(--border)] pt-4">
      ...
      <button wire:click="applyPrices"
        ...
        <span wire:loading.remove wire:target="applyPrices" style="display:inline-flex;align-items:center;gap:6px">
          <x-icon name="check" size="14" /> Apply {{ $this->newCount + $this->updatedCountPreview }} Updates
        </span>
      </button>
      @endif
    </div>

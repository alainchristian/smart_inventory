...
.td-hero-num   { font-size:31px; font-weight:800; color:var(--text); letter-spacing:-.5px; }
.td-hero-badge {
    display:inline-flex; align-items:center; gap:6px;
    padding:5px 14px; border-radius:20px; font-size:17px; font-weight:700;
    letter-spacing:.5px; text-transform:uppercase;
    background:var(--badge-bg); color:var(--badge-color);
}
.td-hero-badge-dot { width:7px; height:7px; border-radius:50%; background:currentColor; }
.td-hero-route { display:flex; align-items:center; gap:10px; font-size:20px; flex-wrap:wrap; }
.td-hero-route-node {
    display:flex;
    align-items:center;
    gap:6px;
...
.td-hero-route-arrow { color:var(--text-sub); font-size:26px; }
.td-hero-divider { width:1px; height:32px; background:var(--border); margin:0 8px; }
.td-hero-date  { font-size:17px; color:var(--text-sub); }
.td-hero-date strong { color:var(--text); display:block; font-size:20px; font-weight:700; }
.td-disc-alert {
    display:inline-flex; align-items:center; gap:6px;
    padding:6px 14px; border-radius:8px; font-size:17px; font-weight:700;
...
.td-tl-label   { font-size:14px; font-weight:700; letter-spacing:.6px; text-transform:uppercase;
...
.td-card-head h3 { font-size:19px; font-weight:700; color:var(--text); margin:0; }
.td-card-head p  { font-size:16px; color:var(--text-sub); margin:0; }
...
.td-table thead th {
    padding:10px 16px; font-size:14px; font-weight:700; letter-spacing:.8px;
...
.td-table tbody td { padding:12px 16px; font-size:19px; color:var(--text); vertical-align:middle; }
.td-table .col-product { font-weight:600; }
.td-table .col-sku     { font-size:16px; color:var(--text-sub); display:block; margin-top:1px; }
.td-table .col-num     { font-weight:700; font-size:20px; }
...
.td-box-code   { font-size:17px; font-weight:700; color:var(--text); font-family:monospace;
...
.td-box-scan   { font-size:16px; color:var(--text-sub); margin-left:auto; }
.td-box-scan strong { color:var(--text); }
.td-box-items  { font-size:16px; color:var(--text-sub); }
...
.td-meta-label { font-size:14px; font-weight:700; letter-spacing:.7px; text-transform:uppercase;
                 color:var(--text-sub); flex-shrink:0; }
.td-meta-value { font-size:19px; font-weight:600; color:var(--text); text-align:right;
                 word-wrap:break-word; overflow-wrap:break-word; min-width:0; }
.td-meta-value.mono { font-family:monospace; font-size:17px; }

/* Transporter card */
.td-transporter-body { padding:16px; max-width:100%; }
.td-trans-name { font-size:23px; font-weight:800; color:var(--text); margin:0 0 4px; word-break:break-word; }
.td-trans-company { font-size:17px; color:var(--text-sub); margin:0 0 12px; word-break:break-word; }
.td-trans-detail { display:flex; flex-direction:column; gap:7px; max-width:100%; }
.td-trans-row  { display:flex; align-items:center; gap:8px; font-size:17px; color:var(--text-sub); word-break:break-word; }
...
.td-btn {
    ...
    padding:10px 16px; border-radius:var(--rsm); font-size:19px; font-weight:700;
...
/* Notes block */
.td-notes {
    padding:14px 16px; font-size:19px; color:var(--text-sub);
...
/* Empty state */
.td-empty { text-align:center; padding:32px; color:var(--text-sub); font-size:19px; }
...
@media(max-width:768px) {
    ...
    .td-hero-num    { font-size:29px; }
    .td-hero-badge  { font-size:16px; }
    .td-hero-route  { font-size:19px; }
}
@media(max-width:600px) {
    /* Hero banner */
    .td-hero        { padding:14px 16px; border-radius:8px; }
    .td-hero-inner  { gap:10px; }
    .td-hero-num    { font-size:26px; }
    .td-hero-badge  { padding:4px 11px; font-size:16px; }
    .td-hero-divider { display:none; }
    .td-hero-route  { width:100%; order:3; font-size:17px; }
    .td-hero-date   { font-size:16px; }
    ...
    .td-card-head h3 { font-size:17px; }
    .td-card-head p  { font-size:14px; }
    ...
    .td-table .col-product { font-size:17px; }
    .td-table .col-sku { font-size:14px; }
    .td-table .col-num { font-size:19px; }
    ...
    .td-box-code    { font-size:16px; }
    .td-box-status  { font-size:13px; }
    .td-box-items   { font-size:14px; }
    .td-box-scan    {
        width:100%;
        margin-left:0;
        font-size:14px;
    ...
    .td-trans-name { font-size:20px; }
    .td-trans-company { font-size:16px; }
    .td-trans-row { font-size:16px; }

    /* Actions */
    .td-actions-body { padding:12px; }
    .td-btn { padding:11px 14px; font-size:17px; }

    /* Notes */
    .td-notes { padding:12px 14px; font-size:17px; }
}
...
@media(max-width:480px) {
    ...
    .td-hero-badge  { padding:4px 10px; font-size:14px; }
    .td-hero-route  {
        font-size:16px;
        gap:8px;
        width:100%;
    ...
    .td-hero-date   { font-size:14px; width:100%; }
    .td-hero-date strong { font-size:16px; }
    .td-disc-alert  { padding:5px 10px; font-size:14px; width:100%; justify-content:center; margin-top:6px; }

    /* Timeline */
    .td-timeline { gap:0; margin-top:14px !important; }
    .td-tl-dot { width:18px; height:18px; }
    .td-tl-dot svg { width:10px; height:10px; }
    .td-tl-label { font-size:8px; line-height:1.3; padding:0 2px; }
    ...
    .td-card-head h3 { font-size:16px; }
    .td-card-head p  { font-size:13px; line-height:1.4; }
    ...
    .td-table .col-product { font-size:16px; max-width:120px; overflow:hidden; text-overflow:ellipsis; }
    .td-table .col-sku { font-size:13px; margin-top:2px; }
    .td-table .col-num { font-size:17px; }
    ...
    .td-meta-label  { font-size:13px; letter-spacing:0.5px; }
    .td-meta-value  {
        font-size:17px;
        word-break:break-word;
        overflow-wrap:break-word;
    ...
    .td-meta-value.mono { font-size:16px; word-break:break-all; }

    /* Boxes */
    .td-box-row     { padding:10px 12px; gap:7px; flex-wrap:wrap; }
    .td-box-code    { font-size:14px; padding:3px 7px; }
    .td-box-status  { font-size:13px; padding:3px 7px; }
    .td-box-items   { font-size:14px; }
    .td-box-scan    {
        font-size:14px;
        width:100%;
    ...
    .td-trans-name { font-size:19px; }
    .td-trans-company { font-size:14px; margin-bottom:10px; }
    .td-trans-row { font-size:14px; gap:6px; }
    .td-trans-row svg { width:11px; height:11px; }

    /* Actions */
    .td-actions-body { padding:10px; }
    .td-btn { padding:10px 12px; font-size:16px; }
    .td-btn svg { width:12px; height:12px; }

    /* Notes */
    .td-notes { padding:10px 12px; font-size:16px; }

    /* Empty state */
    .td-empty { padding:24px 16px; font-size:17px; }
...
<div class="td-wrap"
  ...
  <div style="background:#eff6ff;border:1.5px solid #3b82f6;border-radius:10px;padding:14px 18px;display:flex;align-items:center;gap:12px;">
    ...
    <div>
      <p style="font-size:20px;font-weight:700;color:#1e40af;margin:0 0 2px;">
      ...
      <p style="font-size:19px;color:#1e40af;margin:0;">
        @if($transfer->status === TransferStatus::IN_TRANSIT)

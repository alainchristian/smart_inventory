<div class="card">
  ...
  <div style="display:flex;align-items:center;gap:12px;padding:12px 0;border-bottom:1px solid var(--border)">
    ...
    <div style="flex:1;min-width:0">
      ...
      <div style="display:flex;align-items:center;gap:8px;margin-top:5px">
        ...
        <span style="font-size:11px;font-family:var(--mono);color:var(--text-sub)">
  ...
  <div style="margin-top:14px;padding-top:12px;border-top:1px solid var(--border)">
    ...
    <div style="display:flex;align-items:center;gap:10px;font-size:12px;margin-bottom:7px">
      ...
      <span style="font-family:var(--mono);width:32px;text-align:right;font-weight:600;
                   color:{{ $shop['fill_pct'] >= 50 ? 'var(--success)' :
                           ($shop['fill_pct'] >= 20 ? 'var(--amber)' : 'var(--red)') }}">
        {{ $shop['fill_pct'] }}%
      </span>
      @if($shop['fill_pct'] < 20)
        <span style="color:var(--red);font-size:14px" title="Critical stock level">⚠</span>
      @endif
    </div>
    @endforeach
  </div>

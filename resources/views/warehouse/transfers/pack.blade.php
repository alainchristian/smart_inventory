        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="page-header-wrap">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Pack Transfer</h1>
                        <p class="mt-1 text-base text-gray-600">Scan and assign boxes to prepare transfer for shipping</p>
                    </div>

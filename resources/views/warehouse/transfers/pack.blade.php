<x-app-layout>
    <div class="mb-4 sm:mb-6 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold" style="color:var(--text);">Pack Transfer</h1>
            <p class="text-2xl mt-0.5" style="color:var(--text-dim);">Scan and assign boxes to prepare for shipping</p>
        </div>
    </div>

    <livewire:inventory.transfers.pack-transfer :transfer="$transfer" />
</x-app-layout>

            ...
            <div class="mb-6">
                <div class="page-header-wrap">
                    <div>
                        ...
                        <p class="mt-1 text-2xl text-gray-600">Review and approve or reject the transfer request</p>
                    </div>
                    <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;">
                        ...
                        <a href="{{ route('warehouse.transfers.delivery-note', $transfer) }}" target="_blank"
                           style="display:inline-flex;align-items:center;gap:7px;padding:10px 16px;border-radius:8px;font-size:17px;font-weight:600;text-decoration:none;background:#1a1a2e;color:white;">

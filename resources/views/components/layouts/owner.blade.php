...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Smart Inventory') }} - Owner Dashboard</title>
        ...
        <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 shadow-sm">
            <div class="px-4 lg:px-6">
                <div class="flex items-center justify-between h-16">
                    <a href="{{ route('owner.dashboard') }}" class="flex items-center space-x-3 flex-shrink-0 min-w-[200px]">
                        <x-application-logo class="h-8 w-8" />
                        <span class="text-xl font-bold text-blue-600">Smart Inventory</span>
                    </a>
                    ...
                    <div class="flex-1 max-w-2xl mx-6">
                        <div class="relative">
                            ...
                            <input type="text"
                                   ...
                                   class="block w-full pl-10 pr-4 py-2.5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                        </div>
                    </div>

                    <div x-data="{ notificationsOpen: false, profileOpen: false }" class="flex items-center space-x-4 flex-shrink-0">
                        <div class="relative">
                            ...
                            <div x-show="notificationsOpen"
                                 ...
                                 class="absolute left-auto right-0 top-full mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-[100] overflow-hidden"
                                 style="display: none;">
                                    ...
                                    <a href="#" class="block p-4 hover:bg-gray-50 transition-colors duration-200">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-xs text-gray-600 mt-1">Product XYZ is running low in Warehouse A</p>
                                    ...
                                    <a href="#" class="block p-4 hover:bg-gray-50 transition-colors duration-200">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-xs text-gray-600 mt-1">Transfer #1234 has been completed successfully</p>
                        ...
                        <div class="relative">
                            <button @click="profileOpen = !profileOpen; notificationsOpen = false"
                                ...
                                <div class="relative">
                                    <div class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-white font-semibold text-sm shadow-md">
                            ...
                            <div x-show="profileOpen"
                                 ...
                                 x-transition:leave-start="opacity-100 scale-100"
                                 x-transition:leave-end="opacity-0 scale-95"
                                 class="absolute left-auto right-0 top-full mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 z-[100] overflow-hidden"
                                 style="display: none;">
                                ...
                                <div class="py-2">
                                    <a href="{{ route('owner.settings') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200">
                                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Smart Inventory') }} - Warehouse Manager</title>
    ...
    <body class="font-sans antialiased bg-gray-50" x-data="{ notificationsOpen: false, profileOpen: false }">
        ...
        <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200">
            <div class="px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-14 sm:h-16">
                    <!-- Left: Logo -->
                    <a href="{{ route('warehouse.dashboard') }}" class="flex items-center space-x-2 sm:space-x-3">
                        <x-application-logo class="h-7 w-7 sm:h-8 sm:w-8" />
                        <span class="hidden sm:block text-lg sm:text-xl font-semibold text-amber-600">Smart Inventory</span>
                    </a>
                    ...
                    <div class="hidden md:flex flex-1 max-w-2xl mx-4 lg:mx-8">
                        <div class="relative w-full">
                            ...
                            <input type="text"
                                   ...
                                   class="w-full pl-10 pr-4 py-2 text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-2 sm:space-x-4">
                        ...
                        <div class="relative">
                            <button @click="profileOpen = !profileOpen; notificationsOpen = false"
                                ...
                                <div class="relative">
                                    <div class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-amber-500 to-orange-600 text-white font-semibold text-sm shadow-md">
        ...
        <div x-show="notificationsOpen"
             ...
             class="fixed top-14 right-20 w-80 bg-white rounded-lg shadow-xl border z-50"
             style="display: none;">
            ...
            <div class="max-h-96 overflow-y-auto">
                ...
                <a href="#" class="block p-4 hover:bg-gray-50 transition-colors duration-200">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900">Box Expiring Soon</p>
                            <p class="text-xs text-gray-600 mt-1">Box #ABC123 will expire in 7 days</p>
                ...
                <a href="#" class="block p-4 hover:bg-gray-50 transition-colors duration-200">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900">Transfer Requested</p>
                            <p class="text-xs text-gray-600 mt-1">Shop A requested transfer #1234</p>
        ...
        <div x-show="profileOpen"
             ...
             x-transition:leave-start="opacity-100 scale-100"
             x-transition:leave-end="opacity-0 scale-95"
             class="fixed top-14 right-4 w-56 bg-white rounded-lg shadow-xl border z-50"
             style="display: none;">
            <!-- User Info Header -->

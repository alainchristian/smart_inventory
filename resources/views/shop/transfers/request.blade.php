<x-app-layout>
    <div class="mb-4 sm:mb-6 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl sm:text-3xl font-bold" style="color:var(--text);">New Stock Request</h1>
            <p class="text-xl mt-0.5" style="color:var(--text-dim);">Request boxes from warehouse</p>
        </div>
    </div>
